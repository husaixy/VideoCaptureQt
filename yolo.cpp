...
YOLOV7::YOLOV7(Net_config config)
{
    ...
    string classesFile = "/home/acoinfo/untitled/coco.names";
...
int main()
{
    Net_config YOLOV7_nets = { 0.6, 0.6, "/home/acoinfo/untitled/weights/yolov6n.onnx" };
    YOLOV7 net(YOLOV7_nets);

    string videopath = "/home/acoinfo/untitled/images/123.mp4";
